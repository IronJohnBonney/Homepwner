...
//  Homepwner
//
//  Created by Stephen Looney on 1/24/15.
...
- (void)viewWillAppear:(BOOL)animated;
{
    ...
    NSLog(@"Image Key in Detail View Controller = %@", imageKey);
...
- (IBAction)takePicture:(id)sender {
    ...
    // This line of core will generate a warning right now, ignore it
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField // This protocol method dismisses the keyboard when you're done typing
{
...
didFinishPickingMediaWithInfo:(NSDictionary *)info
{
    ...
    NSString *key = (__bridge NSString *)newUniqueIDString; // Toll-free bridge
    ...
    if([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
        // If on a phone, the image picker is presented modally. Dismiss it.
        [self dismissViewControllerAnimated:YES completion:nil];
    } else {
